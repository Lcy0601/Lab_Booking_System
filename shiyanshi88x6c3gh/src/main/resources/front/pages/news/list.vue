			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 20rpx 200rpx 20rpx","position":"relative","background":"#fff","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx","background":"none","display":"flex","height":"auto"}'>
					<view  :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #999" :style='{"border":"2rpx solid #29828450","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"40rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
					</view>
				...
				<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
					...
					<view class="news-box3" :style='{"width":"100%","padding":"24rpx","margin":"0","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"20rpx 40rpx 20rpx 40rpx","margin":"0","borderColor":"#dddddd","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2rpx 0","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}'>
