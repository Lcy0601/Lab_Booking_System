	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="归还数量" prop="shuliang" >
					<el-input v-model.number="ruleForm.shuliang" placeholder="归还数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="归还数量" prop="shuliang" >
