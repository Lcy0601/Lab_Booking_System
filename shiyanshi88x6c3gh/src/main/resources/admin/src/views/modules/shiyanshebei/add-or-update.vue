	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="设备分类" prop="shebeifenlei" >
					<el-select :disabled="ro.shebeifenlei" v-model="ruleForm.shebeifenlei" placeholder="请选择设备分类"  filterable>
						<el-option
				...
				<el-form-item class="input" v-if="type!='info'"  label="存放地点" prop="cunfangdidian" >
					<el-input v-model="ruleForm.cunfangdidian" placeholder="存放地点" clearable  :readonly="ro.cunfangdidian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="存放地点" prop="cunfangdidian" >
					<el-input v-model="ruleForm.cunfangdidian" placeholder="存放地点" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="适合实验" prop="shiheshiyan" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="适合实验"
					v-model="ruleForm.shiheshiyan" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.shiheshiyan" label="适合实验" prop="shiheshiyan"  class="textBox">
				<span class="text">{{ruleForm.shiheshiyan}}</span>
			</el-form-item>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="使用说明" prop="shiyongshuoming" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.shiyongshuoming" 
					class="editor"
					myQuillEditor="shiyongshuoming"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.shiyongshuoming" label="使用说明" prop="shiyongshuoming"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.shiyongshuoming"></span>
			</el-form-item>
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shiyongshuoming = this.ruleForm.shiyongshuoming.replace(reg,'../../../shiyanshi88x6c3gh/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
