		...
		<div class="login-container" :style="{'backgroundImage': indexBgUrl?`url(${$base.url + indexBgUrl})`:''}">
			<el-form class="login_form animate__animated animate__">
				<div class="login_form2">
					<div class="title-container">基于SpringBoot的高校开放式计算机实验室综合管理平台的设计与实现</div>
...
.login-container {
	...
	.login_form {
		...
		background: url(http://codegen.caihongy.cn/20260124/2c537e6521c44cbab996db4bdc5cb784.jpg) no-repeat left center / 600px 100%,#fff;
		width: 1200px;
		align-items: center;
		height: auto;
		.login_form2 {
