const base = {
	get() {
		return {
			url : "http://localhost:8080/shiyanshi88x6c3gh/",
			name: "shiyanshi88x6c3gh",
			// 退出到首页链接
			indexUrl: 'http://localhost:8080/shiyanshi88x6c3gh/front/h5/index.html'
		};
	},
	getProjectName(){
		return {
			projectName: "基于SpringBoot的高校开放式计算机实验室综合管理平台的设计与实现"
		} 
	},
	getUsersName(){
		return {
