 ...
 */
public class ShiyanshipingjiaModel  implements Serializable {
	...
	public void setShiyanhuanjing(String shiyanhuanjing) {
		this.shiyanhuanjing = shiyanhuanjing;
	}
	
	/**
	 * 获取：实验环境
	 */
	public String getShiyanhuanjing() {
		return shiyanhuanjing;
	}
